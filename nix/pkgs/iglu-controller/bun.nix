...
}:
{
  ...
  "cookies-next@6.1.1" = fetchurl {
     url = "https://registry.npmjs.org/cookies-next/-/cookies-next-6.1.1.tgz";
     hash = "sha512-8JZBc4IN2m8xqOXyG7uicth6yH3SvynAUGSeV/FQ5lcEclzNGoR0+YCjySdn8r6keZdRyGQr4YJ8qy8F+Jq5uw==";
  };
